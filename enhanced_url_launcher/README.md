<?code-excerpt path-base="excerpts/packages/enhanced_url_launcher_example"?>

# enhanced_url_launcher

[![pub package](https://img.shields.io/pub/v/enhanced_url_launcher.svg)](https://pub.dev/packages/enhanced_url_launcher)
...
To use this plugin, add `enhanced_url_launcher` as a [dependency in your pubspec.yaml file](https://flutter.dev/platform-plugins/).
...
check with [`canLaunchUrl`](https://pub.dev/documentation/enhanced_url_launcher/latest/enhanced_url_launcher/canLaunchUrl.html).
...
strings are available by importing `enhanced_url_launcher_string.dart`.
...
[`launchUrl`](https://pub.dev/documentation/enhanced_url_launcher/latest/enhanced_url_launcher/launchUrl.html)
