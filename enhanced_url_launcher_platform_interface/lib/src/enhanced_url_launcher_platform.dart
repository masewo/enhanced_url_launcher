...
import '../link.dart';
import '../method_channel_enhanced_url_launcher.dart';
import '../enhanced_url_launcher_platform_interface.dart';

/// The interface that implementations of enhanced_url_launcher must implement.
///
/// Platform implementations should extend this class rather than implement it as `enhanced_url_launcher`
...
abstract class UrlLauncherPlatform extends PlatformInterface {
  ...
  /// in `package:enhanced_url_launcher/enhanced_url_launcher.dart`.
  Future<bool> launch(
    String url, {
  ...
  Future<bool> launchUrl(String url, LaunchOptions options) {
    ...
    return launch(
      ...
      webOnlyOptions: options.webOnlyOptions,
    );
  }
  ...
  bool? isLastWindowClosed() {
    throw UnimplementedError('isLastWindowClosed() has not been implemented.');
  }
