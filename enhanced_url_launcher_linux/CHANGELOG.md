...
* Changes the major version since, due to a typo in `default_package` in
  existing versions of `enhanced_url_launcher`, requiring Dart registration in this
...
* Fix minor memory leak in Linux enhanced_url_launcher tests.
* Fixes canLaunch detection for URIs addressing on local or network file systems

## 2.0.2

* Replaced reference to `shared_preferences` plugin with the `enhanced_url_launcher` in the README.
...
# 0.0.1+1
* README update for endorsement by enhanced_url_launcher.

# 0.0.1
* The initial implementation of enhanced_url_launcher for Linux
