...
#include "include/enhanced_url_launcher_linux/enhanced_url_launcher_plugin.h"
...
#include "enhanced_url_launcher_plugin_private.h"

// See enhanced_url_launcher_channel.dart for documentation.
const char kChannelName[] = "plugins.flutter.io/enhanced_url_launcher_linux";
