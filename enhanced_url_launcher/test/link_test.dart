...
import 'package:enhanced_url_launcher/link.dart';
import 'package:enhanced_url_launcher/src/link.dart';
import 'package:enhanced_url_launcher_platform_interface/enhanced_url_launcher_platform_interface.dart';

import 'mocks/mock_enhanced_url_launcher_platform.dart';
...
void main() {
  ...
  group('Link', () {
    ...
    testWidgets('calls enhanced_url_launcher for external URLs with blank target',
    ...
    testWidgets('calls enhanced_url_launcher for external URLs with self target',
        (WidgetTester tester) async {
      FollowLink? followLink;
    ...
    testWidgets('pushes to framework for internal route names',
      ...
      // Shouldn't use enhanced_url_launcher when uri is an internal route name.
