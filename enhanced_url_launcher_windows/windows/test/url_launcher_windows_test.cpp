...
TEST(EnhancedUrlLauncherPlugin, CanLaunchSuccessTrue) {
  ...
  EnhancedUrlLauncherPlugin plugin(std::move(system));
...
TEST(EnhancedUrlLauncherPlugin, CanLaunchQueryFailure) {
  std::unique_ptr<MockSystemApis> system = std::make_unique<MockSystemApis>();
...
TEST(EnhancedUrlLauncherPlugin, CanLaunchHandlesOpenFailure) {
  std::unique_ptr<MockSystemApis> system = std::make_unique<MockSystemApis>();
...
TEST(EnhancedUrlLauncherPlugin, LaunchSuccess) {
  std::unique_ptr<MockSystemApis> system = std::make_unique<MockSystemApis>();
...
TEST(EnhancedUrlLauncherPlugin, LaunchReportsFailure) {
  std::unique_ptr<MockSystemApis> system = std::make_unique<MockSystemApis>();
