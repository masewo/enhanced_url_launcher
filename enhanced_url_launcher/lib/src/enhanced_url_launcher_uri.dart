...
import '../enhanced_url_launcher_string.dart';
...
///   [the README](https://pub.dev/packages/enhanced_url_launcher#configuration) for
///   details.
...
bool? isLastWindowClosed() {
  return UrlLauncherPlatform.instance.isLastWindowClosed();
}
...
void downloadBlob(
  ...
  UrlLauncherPlatform.instance.downloadBlob(
    bytes,
    types: types,
    endings: endings,
    fileName: fileName,
